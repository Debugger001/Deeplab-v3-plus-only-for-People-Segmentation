...
CURRENT_DIR=$(pwd)
WORK_DIR="./person_pascal_voc_seg"
mkdir -p "${WORK_DIR}"
cd "${WORK_DIR}"
...
# Root path for PERSON PASCAL VOC 2012 dataset.
PASCAL_ROOT="${WORK_DIR}/personVOCdevkit/personVOC2012"
...
echo "Converting PERSON PASCAL VOC 2012 dataset..."
python ./build_person_voc2012_data.py \
